...
The `image_tags` input is typically generated by [`mozilla/deploy-actions/docker-build`](../docker-build/README.md), but may also be provided manually. See [GAR][1] and [GHCR][2] documentation for how to tag images for these supported registries.
...
- name: Push Docker image to GAR and GHCR
  uses: mozilla/deploy-actions/docker-push@v4
  with:
